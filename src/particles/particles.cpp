...
Particles::~Particles() {
  // ~ParticlesBoundaryValues frees the particle MPI communicator and datatype; without
  // this delete it never ran (matches the Hydro/MHD convention of deleting their bvals)
  delete pbval_part;
}
