...
class Tmunu {
 public:
  ...
  int nfilter_passes;
  bool filter_selftest;      // <particles>/tmunu_filter_selftest: one-time in-situ
                             // impulse/constant/linear verification on the live mesh
 ...
 private:
  ...
  void FilterSelftest();               // fatal on failure; restores u_tmunu

  MeshBlockPack* pmy_pack;
  bool selftest_done_ = false;
};
