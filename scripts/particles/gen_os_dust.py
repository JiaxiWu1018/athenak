...
(particle stress-energy -> Tmunu -> Z4c) plus matching interior+exterior initial data,\
 so it
is intentionally left as a stub here. When implemented it will emit the same HDF5\
 contract as
