...
# Session-2: write beside THIS script's session, never into another session's archive.
OUT_JSON = os.environ.get('PLUMMER_SAMPLER_JSON',
    os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                 'initial_data', 'sampler_validation.json'))
